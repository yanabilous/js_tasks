...
// let arr =[3,3,1]
// if(arr[0]===arr[1]){
//     console.log('число ' + arr[2] +' -порядковый номер числа 3')
// }else{
//     console.log('число ' + arr[0] + ' -порядковый номер числа 1')
// }

// 19 задача
// let arr =[3,3,3,6]
// if(arr[0]===arr[1] && arr[1]===arr[2]){
//     console.log('число ' + arr[3] +' -порядковый номер числа = 4')
// }else{
//     console.log('число ' + arr[0] + ' -порядковый номер числа = 1')
// }
...
// 20 задача 
// let A = 0;
// let B = window.prompt("введите В координаты");
// let C = window.prompt("введите С координаты");
// if (
//   ((B - A) < (C - A) ) 
// ) {
//   console.log('точка В ближе к точке А на ' + (B));
// } else {
//   console.log('точка C ближе к точке А на ' + (C));
// }
...
// let a1 = window.prompt("введите точку")
// if(
//     (a1==a)
// ){
//     console.log(0)
